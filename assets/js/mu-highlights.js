...
(function () {
  ...
  var css = [
    ...
    "#mu-highlights .mu-hl-stat{text-align:center;padding:.75rem .4rem;border-radius:12px;background:var(--global-card-bg-color,#fff);border:1px solid var(--global-divider-color,#e6e6e6);opacity:0;transform:translateY(12px);transition:opacity .5s ease,transform .5s ease;}",
    ...
    "#mu-highlights .mu-hl-num{font-size:1.7rem;font-weight:800;line-height:1;color:var(--global-theme-color,#b509ac);}",
    ...
    "#mu-highlights .mu-hl-card{background:var(--global-card-bg-color,#fff);border:1px solid var(--global-divider-color,#e6e6e6);border-radius:12px;padding:1rem 1.2rem;opacity:0;transform:translateY(16px);transition:opacity .55s ease,transform .55s ease,box-shadow .25s ease;}",
    ...
    "#mu-highlights .mu-hl-card h4{margin:0;font-size:1.05rem;font-weight:700;color:var(--global-theme-color,#b509ac);}",
    ...
    "#mu-highlights .mu-hl-card li{display:flex;gap:.6rem;align-items:flex-start;padding:.34rem 0;font-size:.875rem;line-height:1.4;border-top:1px solid var(--global-divider-color,#eee);}",
    "#mu-highlights .mu-hl-card li:first-child{border-top:none;}",
    "#mu-highlights .mu-hl-card li i{color:var(--global-theme-color,#b509ac);width:1.15rem;text-align:center;margin-top:.18rem;flex:0 0 auto;}",
